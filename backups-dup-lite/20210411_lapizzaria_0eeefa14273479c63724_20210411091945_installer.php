...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210411_lapizzaria_0eeefa14273479c63724_20210411091945_archive.zip';
	const ARCHIVE_SIZE		 = '39549027';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0eeefa1-11091945';
    const SECONDARY_PACKAGE_HASH = 'cc533dc-11091945';
	const VERSION			 = '1.4.0';
